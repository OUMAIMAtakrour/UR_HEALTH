...
export default function Example() {
  return (
    <div>
        <nav className="relative px-4 py-4 flex justify-between items-center border-blue-600 mx-5 rounded-xl">
          ...
          <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            ...
            <div>
              <ul>
                ...
                <li>  <a className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Sign in</a>
           </li>
                <li> <a className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-600 hover:bg-blue-700  rounded-xl" href="#">Sign Up</a>
           </li>
              </ul>
            </div>
