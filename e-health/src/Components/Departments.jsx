      ...
      <div className="  max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="cards">
            ...
            <div className="card red w-full aspect-w-1 aspect-h-1 bg-gray-200 rounded-lg overflow-hidden group-hover:opacity-75">
              <img
                ...
                alt="Neurology"
                className="tip red w-50 z-9 h-full object-center object-cover"
              />
            </div>
