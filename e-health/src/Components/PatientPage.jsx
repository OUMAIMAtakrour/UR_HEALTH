...
function PatientPage() {
  return (
    <div className="all my-5 flex flex-col items-start ml-3 pt-6 pl-10 w-full bg-indigo-500 max-w-[1475px] rounded-[36px] max-md:pl-5 max-md:max-w-full">
          ...
          <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
            ...
            <div className="rectangle2     px-4 w-4/3 mt-1 h-64 bg-white bg-opacity-70 rounded-[500px_500px_0px_0px] max-md:mt-10 max-md:max-w-full">
              <img
                ...
                className="z-10 heart mb-6  w-full aspect-[1.1] max-md:max-w-full"
              />
              </div>
            </div>
          </div>
