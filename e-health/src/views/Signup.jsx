...
setError({__html:finalErrors.join('<br>')})
    ...
    return (
        ...
        <div className="relative overflow-hidden md:flex w-1/2 bg-gradient-to-br from-blue-400 to-green-400 i justify-around items-center hidden">
          <div>
            <h1 className="text-white font-bold text-4xl font-sans">Your Health</h1>
            <p className="text-white mt-1">Is Our Treasure</p>
            <button type="submit" className="block w-28 bg-white text-blue-800 mt-4 py-2 rounded-2xl font-bold mb-2">Read More</button>
          </div>
        ...
        <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
          ...
          {error.__html && (<div className="bg-blue-500 rounded py-2 px-3 w-44 text-white" dangerouslySetInnerHTML={error}>
          ...
          <form onSubmit={onSubmit} className="bg-white" method='POST'>
            ...
            <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
              ...
              <input className="pl-2 outline-none border-none" type="text" name='name' id placeholder="Full name" value={name}
            ...
            <button type="submit" className="block w-full bg-blue-400 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Login</button>
